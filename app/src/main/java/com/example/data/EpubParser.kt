...
object EpubParser {
    suspend fun parseEpubToText(context: Context, bookId: Int, epubFile: File): Int = withContext(Dispatchers.IO) {
        try {
            ...
            com.example.core.LogKeeper.writeLog("EpubParser", android.util.Log.getStackTraceString(e))
            e.printStackTrace()
    ...
    suspend fun parseTxtToText(context: Context, bookId: Int, txtFile: File): Int = withContext(Dispatchers.IO) {
        try {
            ...
            com.example.core.LogKeeper.writeLog("EpubParserTxt", android.util.Log.getStackTraceString(e))
            e.printStackTrace()
            return@withContext -1
        }
    }
